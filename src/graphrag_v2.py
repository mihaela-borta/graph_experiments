...
Original file is located at
    https://colab.research.google.com/drive/1xMlSV9CsTg_SUkF4cyaWbgU4iAQ22T6-
...
!pip install -qqqq llama-index llama-index-graph-stores-neo4j graspologic numpy==1.24.4 scipy==1.12.0
!pip install -qqqq python-dotenv==1.0.1
...
def read_data():
    ...
    news['text_len'] = news['text'].apply(lambda x: len(x))

    mean_text_len = news['text_len'].mean()
    median_text_len = news['text_len'].median()

    print("Mean of text_len:", mean_text_len)
    print("Median of text_len:", median_text_len)
